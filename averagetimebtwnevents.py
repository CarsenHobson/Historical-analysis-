...
output_file_path = '/Users/carsenhobson/Downloads/sapphires_potential_cities/fort_collins/Currentalgo/Eventanalysis2.csv'  # Replace with the desired output CSV file path
